    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            isEdit
              ? <p>
                <input className='bg-gray-50' type='text' value={userData.address.line1} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} />
                <br />
                <input className='bg-gray-50' type='text' value={userData.address.line2} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} />
              </p>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? <input className='max-w-28 bg-gray-100' type='date' onChange={(e)=> setUserData(prev =>({...prev,dob:e.target.value}))}></input> : <p className='text-gray-400'>{userData.dob}</p>
          }
        </div>
      </div>
      <div className='mt-10'>
